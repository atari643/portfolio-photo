...
import { Upload, Image as ImageIcon, Folder, Settings, BarChart3, Users, Palette, Eye, Edit, Trash2 } from 'lucide-react'
import { usePhotos, useGalleries, useCategories, useSettings, useStatistics } from '../../../lib/cms/hooks'
...
export default function AdminPage() {
  ...
  // Hooks CMS
  const { photos, loading: photosLoading, createPhoto, updatePhoto, deletePhoto } = usePhotos()
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            {selectedTab === 'overview' && <OverviewSection stats={stats} loading={statsLoading} />}
            {selectedTab === 'photos' && (
              <PhotoManagementSection 
                photos={photos} 
                categories={categories}
                loading={photosLoading}
                onCreatePhoto={createPhoto}
